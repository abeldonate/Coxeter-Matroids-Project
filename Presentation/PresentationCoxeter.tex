...
\begin{frame}{Coxeter Groups}
  \begin{block}{Definition}
    Given a set of generators $S = \{s_i\}$, a Coxeter group is a group described by its presentation
	\[
	\langle s_1, s_2, \ldots, s_n | (s_is_j)^{m_{ij} = 1} \rangle , \quad m_{ii} = 1, \quad m_{ij}\ge 2 \ \forall i\neq j
	\] 
  \end{block}
